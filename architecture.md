...
```
run_synthea.bat -p 6000 -s 42 California
run_synthea.bat -p 5000 -s 43 Florida
run_synthea.bat -p 4000 -s 44 Texas
run_synthea.bat -p 3000 -s 45 Pennsylvania
run_synthea.bat -p 2000 -s 46 "New York"
